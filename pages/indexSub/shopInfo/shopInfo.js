...
export default {
	...
	methods: {
		...
		async getStoreDetails(id) {
			...
			// shopIntroduceUrl: app.OutUrl + '/upload/store/' + returnData.storeID + '/html/ShowHallDetails.html',
			// shopCustomUrl: app.OutUrl + '/upload/store/' + returnData.storeID + '/html/StoreSelfShowDetails.html',
